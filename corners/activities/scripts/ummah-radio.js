...
(function () {
  ...
  function readSegment(i) {
    ...
    try {
      ...
      const v = (L==="ar"&&window.MKVoice&&MKVoice.bestVoice("ar",MKVoice.guessGender(SEGMENTS[i].text[L]))) || speechSynthesis.getVoices().find(v => v.lang && v.lang.startsWith(L === "ar" ? "ar" : "en"));
