...
/* ───────────── 5 · The Poor Employee ───────────── */
{
  ...
  logic:{
    ar:'فَكِّر: لو كانَ لَكَ <b>خَمسةُ آباءٍ</b> كُلُّ واحِدٍ يَأمُرُكَ بِعَكسِ الآخَر، هل ستَرتاح؟ ستَعيشُ في صُداعٍ دائِم! لكنَّ أباً واحِداً يُحِبُّكَ ويَعرِفُ مَصلَحَتَكَ يُريحُ قَلبَكَ. التَّوحيدُ ليسَ قَيداً، بَل هو <b>الرّاحةُ والأمان</b>: قَلبٌ واحِدٌ، وَجهةٌ واحِدة، رَبٌّ واحِدٌ يُحِبُّكَ ويَكفيك. الشِّركُ حَيرةٌ وتَمَزُّق، والتَّوحيدُ سَلامٌ وسَكينة.',
    en:'Think: if you had <b>five fathers</b>, each ordering you the opposite of the other, would you be at ease? You\'d live in a constant headache! But one father who loves you and knows what\'s best brings your heart rest. Tawheed is not a restriction — it is <b>peace and security</b>: one heart, one direction, one Lord who loves you and is enough for you. Shirk is confusion and division; Tawheed is peace and tranquillity.' },
